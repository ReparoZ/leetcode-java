package testcase.algorithms.A0876_MiddleOfTheLinkedList;

import problems.algorithms.A0876_MiddleOfTheLinkedList.ListNode;
import problems.algorithms.A0876_MiddleOfTheLinkedList.Solution;

import java.util.Arrays;

/**
 * A0876_MiddleOfTheLinkedList
 *
 * @author reparo
 * @date 2021/11/14
 */
public class TestCase {
    ...
    public static void main(String[] args) {
        test(new int[]{1, 2, 3, 4, 5}, "345");
        test(new int[]{1, 2, 3, 4, 5, 6}, "456");
    }

    public static void test(int[] nums, String expectedResult) {
        final ListNode listNode = new Solution().middleNode(genListNode(nums));
